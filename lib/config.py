...
__C.LI_FUSION.POINT_CHANNELS = [96, 256, 512, 1024]
__C.LI_FUSION.FA_POINT_CHANNELS = [1024, 512, 512, 256, 128]
__C.LI_FUSION.AAF_POINT_CHANNELS = [512, 1024, 2048, 256]
...
__C.RPN.TARGET_CONFIG = edict()
__C.RPN.TARGET_CONFIG.GT_EXTRA_WIDTH = [0.2, 0.2, 0.2]
__C.RPN.TARGET_CONFIG.BOX_CODER = 'PointResidualCoder'
__C.RPN.TARGET_CONFIG.BOX_CODER_CONFIG = edict()
__C.RPN.TARGET_CONFIG.BOX_CODER_CONFIG.use_mean_size = True
__C.RPN.TARGET_CONFIG.BOX_CODER_CONFIG.mean_size = [[ 3.9, 1.6, 1.56 ],
                                                    [ 0.8, 0.6, 1.73 ],
                                                    [ 1.76, 0.6, 1.73 ]]
# config of testing
...
__C.RCNN.USE_RGB = False
__C.RCNN.USE_MEAN_COVARIANCE =False
# config of bin-based loss
...
#
__C.RCNN.IOU_LOSS_TYPE = 'raw'
__C.RCNN.IOU_ANGLE_POWER = 1
...
#
__C.TRAIN.RPN_TRAIN_WEIGHT = 1.0
__C.TRAIN.RCNN_TRAIN_WEIGHT = 1.0
__C.TRAIN.CE_WEIGHT = 5.0
__C.TRAIN.IOU_LOSS_TYPE = 'cls_mask_with_bin'
__C.TRAIN.BBOX_AVG_BY_BIN = True
__C.TRAIN.RY_WITH_BIN = False
