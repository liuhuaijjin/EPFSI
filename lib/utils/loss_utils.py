...
from lib.utils.iou3d_sessd import iou3d_utils
...
def get_reg_loss(cls_score, mask_score, pred_reg, reg_label, loc_scope, loc_bin_size, num_head_bin, anchor_size,
    ...
    ry_bin_onehot.scatter_(1, ry_bin_label.view(-1, 1).long(), 1) #one-hot编码
    ...
    if cfg.TRAIN.IOU_LOSS_TYPE == 'raw':
        ...
        pred_x_bin = F.softmax(pred_reg[:, x_bin_l: x_bin_r], 1) #沿指定维度做归一化
