...
def model_joint_fn_decorator():
    ...
    def get_rcnn_loss(model, ret_dict, tb_dict):
        ...
        if fg_sum != 0:
            ...
            #loss_odious=odious_3d_loss(roi_boxes3d,gt_boxes3d_ct,1,2)
            loss_odious=odious_3d_loss(roi_boxes3d[fg_mask],gt_boxes3d_ct[fg_mask],1,2)
            print(roi_boxes3d[fg_mask],gt_boxes3d_ct[fg_mask],loss_odious,1)
            loss_loc, loss_angle, loss_size, loss_iou, reg_loss_dict = \
        ...
        if cfg.USE_IOU_BRANCH:
            ...
            #tb_dict['rcnn_loss_odious'] = loss_odious.item()
            # print('\n')
