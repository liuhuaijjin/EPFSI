...
from lib.pcdet.models.dense_heads.point_intra_part_head import PointIntraPartOffsetHead
...
class RPN(nn.Module):
    def __init__(self, use_xyz = True, mode = 'TRAIN'):
        ...
        #part branch
        self.PointIntraPartOffsetHead=PointIntraPartOffsetHead(num_class=1, input_channels=128, model_cfg=cfg.RPN)
    ...
    def forward(self, input_data):
        ...
        ret_dict = { 'rpn_cls'     : rpn_cls, 'rpn_reg': rpn_reg, #'gt_boxes3d':input_data['gt_boxes3d'],
                     'backbone_xyz': backbone_xyz, 'backbone_features': backbone_features
                     }

        #ret_dict = self.PointIntraPartOffsetHead(ret_dict)
